...
- [Recommendation](#odigos-io-v1alpha1-Recommendation)
- [Sampling](#odigos-io-v1alpha1-Sampling)
...
## `Recommendation` <a id="odigos-io-v1alpha1-Recommendation"></a>

<p>Recommendation is the Schema for enabling a catalog recommendation in the cluster.</p>
...
<tr><td><code>apiVersion</code></td><td>string</td><td><code>odigos.io/v1alpha1</code></td></tr>
<tr><td><code>kind</code></td><td>string</td><td><code>Recommendation</code></td></tr>
...
<td>
<a href="#odigos-io-v1alpha1-RecommendationSpec"><code>RecommendationSpec</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<td>
<a href="#odigos-io-v1alpha1-RecommendationStatus"><code>RecommendationStatus</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
## `Sampling` <a id="odigos-io-v1alpha1-Sampling"></a>

<p>Sampling is the Schema for the sampling rules API.</p>
...
<tr><td><code>apiVersion</code></td><td>string</td><td><code>odigos.io/v1alpha1</code></td></tr>
<tr><td><code>kind</code></td><td>string</td><td><code>Sampling</code></td></tr>
...
<td>
<a href="#odigos-io-v1alpha1-SamplingSpec"><code>SamplingSpec</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<td>
<a href="#odigos-io-v1alpha1-SamplingStatus"><code>SamplingStatus</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<td>
<code>actions.PiiMaskingConfig</code>
</td>
<td>
...
<tr>
<td>
<code>extractAttribute</code> <B>[Required]</B>
</td>
<td>
<code>actions.ExtractAttributeConfig</code>
</td>
<td>
   <p>ExtractAttribute is the config for the ExtractAttribute Action.</p>
</td>
</tr>
<tr>
<td>
<code>dbQueryTemplatization</code> <B>[Required]</B>
</td>
<td>
<code>actions.DbQueryTemplatizationConfig</code>
</td>
<td>
   <p>DbQueryTemplatization is the config for the DbQueryTemplatization Action.</p>
</td>
</tr>
<tr>
<td>
<code>inferDbAttributes</code> <B>[Required]</B>
</td>
<td>
<code>actions.InferDbAttributesConfig</code>
</td>
<td>
   <p>InferDbAttributes is the config for the InferDbAttributes Action.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<code>serviceGraphExtraDimensions</code> <B>[Required]</B>
</td>
<td>
<code>[]string</code>
</td>
<td>
   <p>ServiceGraphExtraDimensions are additional span attribute names to include as dimensions
in the service graph metrics, on top of the default service.name dimension.</p>
</td>
</tr>
<tr>
<td>
<code>serviceGraphVirtualNodePeerAttributes</code> <B>[Required]</B>
</td>
<td>
<code>[]string</code>
</td>
<td>
   <p>ServiceGraphVirtualNodePeerAttributes is an ordered list of span attributes used to identify
uninstrumented (virtual) nodes in the service graph.
The connector picks the first attribute that has a value on the span.
When nil/empty, the connector uses its built-in defaults: [peer.service, db.name, db.system].</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<code>resourceDetectors</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common#ResourceDetectorsConfiguration"><code>common.ResourceDetectorsConfiguration</code></a>
</td>
<td>
   <p>ResourceDetectors controls which OpenTelemetry resource detectors are enabled
on the node collector's resourcedetection processor.</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<code>traceCorrelations</code> <B>[Required]</B>
</td>
<td>
<a href="#odigos-io-v1alpha1-CollectorsGroupTraceCorrelationsSettings"><code>CollectorsGroupTraceCorrelationsSettings</code></a>
</td>
<td>
   <p>TraceCorrelations holds trace correlations configuration derived from OdigosConfiguration.
Currently only relevant for the cluster gateway collector.</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<code>tailSampling</code> <B>[Required]</B>
</td>
<td>
<code>common/api/sampling.TailSamplingConfiguration</code>
</td>
<td>
   <p>Sampling holds the sampling configuration derived from the OdigosConfiguration.
Currently this is only relevant for the cluster gateway collector.</p>
</td>
</tr>
<tr>
<td>
<code>samplingDryRun</code> <B>[Required]</B>
</td>
<td>
<code>bool</code>
</td>
<td>
   <p>Set to true to enable dry run mode for sampling.
...
before committing to any changes that might lose data.</p>
</td>
</tr>
<tr>
<td>
<code>spanSamplingAttributes</code> <B>[Required]</B>
</td>
<td>
<code>common/api/sampling.SpanSamplingAttributesConfiguration</code>
</td>
<td>
   <p>Controls whether spans are enhanced with sampling attributes (e.g. category and decisions).
Capturing these attributes gives visibility into sampling decision-making and effective
sampling percentages when viewing traces or querying the database with tools.</p>
</td>
</tr>
</tbody>
</table>
...
## `CollectorsGroupTraceCorrelationsSettings` <a id="odigos-io-v1alpha1-CollectorsGroupTraceCorrelationsSettings"></a>
...
<p>CollectorsGroupTraceCorrelationsSettings holds trace correlations configuration
derived from OdigosConfiguration. Currently only relevant for the cluster gateway collector.</p>
...
<tr>
<td>
<code>serviceIO</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common#TraceCorrelationsServiceIOConfiguration"><code>common.TraceCorrelationsServiceIOConfiguration</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<td>
<code>common/api/agentsignalconfig.AgentTracesConfig</code>
</td>
<td>
...
<td>
<code>common/api/agentsignalconfig.AgentMetricsConfig</code>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<td>
<code>common/api/agentsignalconfig.AgentLogsConfig</code>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<tr>
<td>
<code>agentDiagnostics</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#AgentDiagnostics"><code>common/api/instrumentationrules.AgentDiagnostics</code></a>
</td>
<td>
   <p>Configure the log level for the agent itselg</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<code>allowConcurrentAgents</code> <B>[Required]</B>
</td>
<td>
<code>bool</code>
</td>
<td>
   <p>Odigos by default will attempt to detect if another agent is already running in the container,
...
when not empty, the value will override the global config for this container</p>
</td>
</tr>
</tbody>
</table>

## `CostReductionRule` <a id="odigos-io-v1alpha1-CostReductionRule"></a>


**Appears in:**

- [SamplingSpec](#odigos-io-v1alpha1-SamplingSpec)
...
<td>
   <p>user provided name, for easier identification and reference.
...
but it is written as metric attribute, and stored as span attribute on participating spans.</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>if set to true, the rule will be disabled,
e.g. will not be taken into account for any sampling decisions.
disabled rules still participate in metrics calculations,
allowing enhanced tools and data for troubleshooting and sampling maintenance.</p>
</td>
</tr>
<tr>
<td>
<code>sourceScopes</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/api/k8sconsts#SourcesScopes"><code>k8sconsts.SourcesScopes</code></a>
</td>
<td>
   <p>limit this rule to specific sources (by name, namespace, language, etc.)
an empty list will match any source.
if multiple items are set, the operation match if any one matches
this relates to the &quot;ResourceAttributes&quot; part of a span.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<code>common/api/sampling.TailSamplingOperationMatcher</code>
</td>
<td>
   <p>limit this rule to specific operations.
for example: specific endpoint or kafka topic.
this field is optional, and if not set, the rule will be applied to all operations.</p>
</td>
</tr>
<tr>
<td>
<code>percentageAtMost</code> <B>[Required]</B>
</td>
<td>
<code>float64</code>
</td>
<td>
   <p>sampling percentage for cost reduction.
this field is required.
the final sampling percentage for traces that match this rule
will be the highest possible, but at most this value.</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>optional free-form text field that allows you to attach notes
for future context and maintenance.
users can write why this rule was added, observations, document considerations, etc.</p>
</td>
</tr>
</tbody>
</table>
...
## `HighlyRelevantOperation` <a id="odigos-io-v1alpha1-HighlyRelevantOperation"></a>
...
<p>define operations (spans) with high observability value.
if found anywhere in the trace, the entire trace will be kept
regaradless of any cost reduction rules.</p>
...
<td>
   <p>limit the operation to specific sources.
an empty list will match any source.
if multiple items are set, the operation match if any one matches
this relates to the &quot;ResourceAttributes&quot; part of a span.</p>
</td>
...
<tr>
<td>
<code>error</code> <B>[Required]</B>
</td>
<td>
<code>bool</code>
</td>
<td>
   <p>if &quot;Error&quot; is set to true, only spans with SpanStatus set to &quot;Error&quot; are considered</p>
</td>
</tr>
<tr>
<td>
<code>durationAtLeastMs</code> <B>[Required]</B>
</td>
<td>
<code>int</code>
</td>
<td>
   <p>if Duration is set, only operations with duration in milli seconds larger then this value are considered</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>optionally, limit this rule to specific operations.
for example: specific endpoint or kafka topic.
this field is optional, and if not set, the rule will be applied to all operations.</p>
</td>
</tr>
<tr>
<td>
<code>percentageAtLeast</code> <B>[Required]</B>
</td>
<td>
<code>float64</code>
</td>
<td>
   <p>traces that contains this operation will be sampled by at least this percentage.
if unset, 100% of such the traces will be sampled.</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<code>workloadCollectorConfig</code> <B>[Required]</B>
</td>
<td>
<code>[]common/api.ContainerCollectorConfig</code>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<tr>
<td>
<code>postInstrumentHealthMonitor</code> <B>[Required]</B>
</td>
<td>
<a href="#odigos-io-v1alpha1-PostInstrumentHealthMonitor"><code>PostInstrumentHealthMonitor</code></a>
</td>
<td>
   <p>The post instrument health monitor tracking for the workload.
nil when the source has no agent injection enabled and thus not instrumented by odigos.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<code>scopes</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/api/k8sconsts#SourcesScopes"><code>k8sconsts.SourcesScopes</code></a>
</td>
<td>
   <p>SourcesScopes lists SourcesScope entries to which the rule should be applied. If unset or empty, the rule applies to all workloads.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#PayloadCollection"><code>common/api/instrumentationrules.PayloadCollection</code></a>
</td>
<td>
...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#OtelDistros"><code>common/api/instrumentationrules.OtelDistros</code></a>
</td>
<td>
...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#CodeAttributes"><code>common/api/instrumentationrules.CodeAttributes</code></a>
</td>
<td>
...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#HttpHeadersCollection"><code>common/api/instrumentationrules.HttpHeadersCollection</code></a>
</td>
<td>
...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#TraceConfig"><code>common/api/instrumentationrules.TraceConfig</code></a>
</td>
<td>
...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#CustomInstrumentations"><code>common/api/instrumentationrules.CustomInstrumentations</code></a>
</td>
<td>
...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#HeadSamplingFallbackFraction"><code>common/api/instrumentationrules.HeadSamplingFallbackFraction</code></a>
</td>
<td>
...
@deprecated: use odigos config to set this value instead.</p>
</td>
</tr>
<tr>
<td>
<code>ebpfLogCapture</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#EbpfLogCapture"><code>common/api/instrumentationrules.EbpfLogCapture</code></a>
</td>
<td>
   <p>Configure eBPF-based log capture. When enabled, the node collector logs pipeline
will use only the eBPF receiver instead of the filelog receiver, and odiglet will
register instrumented processes for eBPF log capture.</p>
</td>
</tr>
<tr>
<td>
<code>networkMetrics</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#NetworkMetricsConfig"><code>common/api/instrumentationrules.NetworkMetricsConfig</code></a>
</td>
<td>
   <p>Configure network flow and TCP stats metrics for scoped workloads.</p>
</td>
</tr>
<tr>
<td>
<code>traceVerbosity</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#TraceVerbosity"><code>common/api/instrumentationrules.TraceVerbosity</code></a>
</td>
<td>
   <p>Configure the verbosity of the traces for the library.</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>Configure the agent own logging configuration.</p>
</td>
</tr>
</tbody>
</table>
...
## `NoisyOperation` <a id="odigos-io-v1alpha1-NoisyOperation"></a>
...
<p>endpoints (or other operations) which are considered &quot;noise&quot;, and provide no or very little observability value.
these traces should not be collected at all, or dropped aggresevly.
motivation is data sentization and performance improvment (even if cost is not a factor)</p>
<p>examples:</p>
<ul>
<li>health-checks (readiness and liveness probes)</li>
<li>metrics scrape endpoints (prometheus /metrics endpoint)</li>
<li>other agents calling home (outgoing http requests to collector.my.vendor.com)</li>
</ul>
...
if the list is empty - all sources are matched.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<code>common/api/sampling.HeadSamplingOperationMatcher</code>
</td>
<td>
   <p>limit this rule to specific operations.
...
<td>
   <p>sampling percentage for noisy operations.
...
## `PostInstrumentHealthMonitor` <a id="odigos-io-v1alpha1-PostInstrumentHealthMonitor"></a>
...
<tr>
<td>
<code>healthCheckResult</code> <B>[Required]</B>
</td>
<td>
<code>bool</code>
</td>
<td>
   <p>Once the post instrument health check is completed, the result is stored here.
nil means that the health check is not yet completed.</p>
</td>
</tr>
<tr>
<td>
<code>unhealthyReason</code>
</td>
<td>
<a href="#odigos-io-v1alpha1-PostInstrumentHealthUnhealthyReason"><code>PostInstrumentHealthUnhealthyReason</code></a>
</td>
<td>
   <p>Set only when HealthCheckResult is false. Describes why the health check failed.</p>
</td>
</tr>
<tr>
<td>
<code>unhealthyAt</code>
</td>
<td>
<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.31/#time-v1-meta"><code>meta/v1.Time</code></a>
</td>
<td>
   <p>Set only when HealthCheckResult is false. The time when the workload was first observed as unhealthy.</p>
</td>
</tr>
<tr>
<td>
<code>firstInstrumentedPodStartTime</code> <B>[Required]</B>
</td>
<td>
<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.31/#time-v1-meta"><code>meta/v1.Time</code></a>
</td>
<td>
   <p>This is the time when we observed the first pod running with the odigos agent injected.
...
When pod manifest injection is optional, this time is accounted correctly.</p>
</td>
</tr>
</tbody>
</table>

## `PostInstrumentHealthUnhealthyReason` <a id="odigos-io-v1alpha1-PostInstrumentHealthUnhealthyReason"></a>

(Alias of `string`)

**Appears in:**

- [PostInstrumentHealthMonitor](#odigos-io-v1alpha1-PostInstrumentHealthMonitor)
...
<td>
   <p>Represents the observations of a processor's current state.</p>
</td>
</tr>
</tbody>
</table>

## `RecommendationSpec` <a id="odigos-io-v1alpha1-RecommendationSpec"></a>
...
<p>RecommendationSpec defines the desired state of Recommendation</p>
...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common#RecommendationType"><code>common.RecommendationType</code></a>
</td>
<td>
   <p>Type identifies which recommendation from the catalog this resource enables.</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>Applied indicates whether this recommendation is currently applied
(via the recommendation flow or configured organically).</p>
</td>
</tr>
<tr>
<td>
<code>conditionsMet</code>
</td>
<td>
<code>bool</code>
</td>
<td>
   <p>ConditionsMet indicates whether the catalog prerequisites for this recommendation
currently hold (for example GoEnterpriseSources for AutoGoOffsetUpdater).</p>
</td>
</tr>
</tbody>
</table>

## `RecommendationStatus` <a id="odigos-io-v1alpha1-RecommendationStatus"></a>
...
<p>RecommendationStatus defines the observed state of Recommendation</p>
...
<td>
   <p>Represents the observations of a recommendation's current state.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<code>otherAgents</code> <B>[Required]</B>
</td>
<td>
<a href="#odigos-io-v1alpha1-OtherAgent"><code>[]OtherAgent</code></a>
</td>
<td>
   <p>OtherAgents lists other instrumentation agents detected in the container
(a process can carry more than one); empty when none.</p>
</td>
</tr>
<tr>
<td>
...
## `SamplingSpec` <a id="odigos-io-v1alpha1-SamplingSpec"></a>
...
for example - by team, by client, by usecase, admin-policy, etc.</p>
...
<td>
   <p>give these sampling rules a name for display, easier identification and reference.</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>a free-form text field that allows you to attach notes regardinag the rule for convenience.
Odigos does not use or assume any meaning from this field.</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>if set to true, the sampling rules will be disabled,
they will not be taken into account for any sampling decisions.
useful if you want to temporarily disable the rules but re-enable them later,</p>
</td>
</tr>
<tr>
<td>
...
<td>
<a href="#odigos-io-v1alpha1-NoisyOperation"><code>[]NoisyOperation</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<tr>
<td>
<code>highlyRelevantOperations</code> <B>[Required]</B>
</td>
<td>
<a href="#odigos-io-v1alpha1-HighlyRelevantOperation"><code>[]HighlyRelevantOperation</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<tr>
<td>
<code>costReductionRules</code> <B>[Required]</B>
</td>
<td>
<a href="#odigos-io-v1alpha1-CostReductionRule"><code>[]CostReductionRule</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
## `SamplingStatus` <a id="odigos-io-v1alpha1-SamplingStatus"></a>
...
<p>SamplingStatus defines the observed state of Sampling.</p>
...
<td>
   <p>Represents the observations of a Sampling's current state.
Known .status.conditions.type are: &quot;Available&quot;, &quot;Progressing&quot;</p>
</td>
</tr>
</tbody>
