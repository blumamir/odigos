module github.com/odigos-io/odigos/collector/processor/odigosservicenameprocessor
...
replace (
	github.com/odigos-io/odigos/api v0.0.0 => ../../../api
	github.com/odigos-io/odigos/common v0.0.0 => ../../../common
)
