...
import { GoLogo, OverviewIcon, PipelineCollectorIcon, SamplingIcon, ServiceMapIcon, SettingsIcon } from '@odigos/ui-kit/icons';
...
export const getNavbarIcons = (router: AppRouterInstance, currentPath: string) => {
  const navIcons: NavbarProps['icons'] = [
    ...
    getPayloadForIcon(router, currentPath, ROUTES.GO_OFFSETS, 'Go Offsets', GoLogo),
